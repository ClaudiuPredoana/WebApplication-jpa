package com.predoana.web.app.orders;
...
@EnableJpaRepositories(
        basePackages = "com.predoana.web.app.orders.repositories",
...
public class OrdersDBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean ordersEntityManagerFactory()
    {
        ...
        factory.setPackagesToScan("com.predoana.web.app.orders.entities");
