package com.predoana.web.app.security;
...
@EnableJpaRepositories(
        basePackages = "com.predoana.web.app.security.repositories",
...
private Environment env;
    ...
    securityEntityManagerFactory()    {
        ...
        factory.setPackagesToScan("com.predoana.web.app.security.entities");
    ...
    public DataSourceInitializer securityDataSourceInitializer()    {
        ...
        dsInitializer.setEnabled(env.getProperty("datasource.security.initialize",                                Boolean.class, false) );        return dsInitializer;    }
}
